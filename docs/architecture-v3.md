...
The original v3 increment reconciled the design and evaluation boundary. R2 implementation and bounded observations remain historical evidence in the [R2 trial record](../tests/r2/README.md) for its recorded hashes. R3 and R4 package capabilities are described here and their observations belong in the [R3 trial record](../tests/r3/README.md) and [R4 trial record](../tests/r4/README.md); R5 capability is described here and its observations belong in the separate [R5 trial record](../tests/r5/README.md). Detailed M8 observations and limits remain in that R5 record. Do not infer combined acceptance, native interruption/crash recovery, host qualification beyond the observed surface, or behavioral results from package presence. Installation/discovery claims, broader qualification, and performance claims remain limited by recorded evidence.
